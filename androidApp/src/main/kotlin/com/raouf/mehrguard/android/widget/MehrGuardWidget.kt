...
package com.raouf.mehrguard.android.widget
...
import com.raouf.mehrguard.android.MainActivity
 ...
 */
class MehrGuardWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        provideContent {
            MehrGuardWidgetContent()
        }
    }

    @Composable
    private fun MehrGuardWidgetContent() {
 ...
 */
class MehrGuardWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = MehrGuardWidget()
}
