...
package com.qrshield.android.ota

import android.content.Context
import android.util.Log
import com.qrshield.ota.OtaHttpClient
import com.qrshield.ota.OtaStorage
...
class AndroidOtaHttpClient : OtaHttpClient {
    ...
    override suspend fun get(url: String): String = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            connection.setRequestProperty("User-Agent", "QRShield-Android/1.3.0")
