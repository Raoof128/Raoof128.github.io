package com.raouf.mehrguard.desktop

import androidx.compose.runtime.getValue
import androidx.compose.runtime.mutableStateOf
import androidx.compose.runtime.setValue
import com.raouf.mehrguard.core.PhishingEngine
import com.raouf.mehrguard.core.ScoringConfig
...
import com.raouf.mehrguard.data.HistoryRepositoryFactory
import com.raouf.mehrguard.data.ScanHistoryManager
import com.raouf.mehrguard.model.ContentType
import com.raouf.mehrguard.model.RiskAssessment
import com.raouf.mehrguard.model.ScanHistoryItem
...
import com.raouf.mehrguard.platform.PlatformClipboard
import com.raouf.mehrguard.platform.PlatformTime
import com.raouf.mehrguard.platform.PlatformUrlOpener
import com.raouf.mehrguard.scanner.DesktopQrScanner
import com.raouf.mehrguard.security.InputValidator
import com.raouf.mehrguard.share.ShareManager
import com.raouf.mehrguard.desktop.ui.AppNotification
import com.raouf.mehrguard.desktop.ui.NotificationType
...
class AppViewModel(
    ...
    private fun handleScanResult(result: com.raouf.mehrguard.model.ScanResult, source: ScanSource) {
        when (result) {
            ...
            is com.raouf.mehrguard.model.ScanResult.Error -> setError(result.message) // message from result might need translation if it's fixed? assuming it's dynamic or english.
            is com.raouf.mehrguard.model.ScanResult.NoQrFound -> setError("No QR code found in image")
        }
    }
    ...
    fun exportFullUserData() {
        ...
        val file = defaultExportFile("mehrguard_full_export", "json")
        try {
    ...
    private fun defaultExportFile(baseName: String, extension: String): File {
        ...
        val safeName = sanitized.ifBlank { "mehrguard_export" }
