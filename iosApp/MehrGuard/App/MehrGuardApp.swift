...
// App/MehrGuardApp.swift
// Mehr Guard iOS Application - iOS 17+ Liquid Glass Edition
//
...
struct MehrGuardApp: App {
    ...
    /// URL scheme: mehrguard://scan
    private func handleDeepLink(_ url: URL) {
        guard url.scheme == "mehrguard" else { return }
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            // Log app launch
            #if DEBUG
            print("🛡️ Mehr Guard launched - iOS 17+")
            #endif
        }
