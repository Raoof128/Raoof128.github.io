...
// Mehr Guard Report Generation - iOS 17+ Liquid Glass Edition
//
...
struct ExpandedPreviewSheet: View {
    ...
    private func generateContent() -> String {
        ...
        case .pdf:
            ...
            Detailed Analysis
            -----------------
            This URL has been flagged as potentially malicious based on multiple security indicators detected by the Mehr Guard offline analysis engine.
            ...
            ---
            Generated by Mehr Guard for iOS 17+
            """
        case .json:
            return """
            {
