...
// Mehr Guard Trust Centre - iOS 17+ Liquid Glass Edition
//
...
struct TrustCentreView: View {
    ...
    private var aboutSection: some View {
        VStack(alignment: .leading, spacing: 4) {
            sectionHeader("About Mehr Guard")
    ...
    private var privacyPolicyText: String {
        ...
        1. DATA COLLECTION
        ------------------
        Mehr Guard is designed with privacy as a core principle. We do NOT collect, store, or transmit any of your scanned URLs or personal data.
        ...
        ----------------------
        Mehr Guard does not integrate with any third-party analytics, advertising, or tracking services.
    ...
    private var licensesText: String {
        ...
        Mehr Guard uses the following open source components:
        ...
        Mehr Guard is open source software.
    ...
    private var acknowledgementsText: String {
        ...
        Mehr Guard was created for the KotlinConf '26 Student Coding Competition.
        ...
        Mehr Guard: Scan. Detect. Protect.
        """
    }
