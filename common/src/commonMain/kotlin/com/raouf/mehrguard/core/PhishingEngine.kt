...
import com.raouf.mehrguard.engine.BrandDetector
import com.raouf.mehrguard.engine.HeuristicsEngine
import com.raouf.mehrguard.engine.TldScorer
import com.raouf.mehrguard.ml.EnsembleModel
import com.raouf.mehrguard.ml.FeatureExtractor
import com.raouf.mehrguard.ml.LogisticRegressionModel
...
class PhishingEngine(
    ...
    private fun performAnalysisWithErrorHandling(url: String): RiskAssessment {
        ...
        val dynamicBrandResult = try {
            com.raouf.mehrguard.engine.DynamicBrandDiscovery.analyze(url)
        } catch (e: Exception) {
            logError("DynamicBrandDiscovery", e)
            com.raouf.mehrguard.engine.DynamicBrandDiscovery.DiscoveryResult(
    ...
    private fun logError(component: String, error: Exception) {
        com.raouf.mehrguard.platform.PlatformLogger.error(
            tag = "PhishingEngine",
    ...
    private fun performAnalysis(url: String): RiskAssessment {
        ...
        val dynamicBrandResult = com.raouf.mehrguard.engine.DynamicBrandDiscovery.analyze(url)
