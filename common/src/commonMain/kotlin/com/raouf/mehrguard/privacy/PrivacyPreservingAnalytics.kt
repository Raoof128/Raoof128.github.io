...
class PrivacyPreservingAnalytics(
    ...
    private val ecdhKeyPair = com.raouf.mehrguard.crypto.SecureECDH.generateKeyPair()
     ...
     *
     * @see com.raouf.mehrguard.crypto.SecureECDH for the Curve25519 implementation
     */
    private fun generateSecureAggregationMask(): FloatArray {
        ...
        val simulatedPeer = com.raouf.mehrguard.crypto.SecureECDH.generateKeyPair()
        
        // Compute ECDH shared secret using Curve25519
        val sharedSecret = com.raouf.mehrguard.crypto.SecureECDH.computeSharedSecret(
