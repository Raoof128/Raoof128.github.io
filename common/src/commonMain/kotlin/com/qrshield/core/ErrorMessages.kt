...
object ErrorMessages {
     ...
     */
    fun forCode(code: com.qrshield.model.ErrorCode): String {
        return when (code) {
            com.qrshield.model.ErrorCode.CAMERA_PERMISSION_DENIED -> Scanner.CAMERA_PERMISSION_DENIED
            com.qrshield.model.ErrorCode.CAMERA_NOT_AVAILABLE -> Scanner.CAMERA_NOT_AVAILABLE
            com.qrshield.model.ErrorCode.CAMERA_ERROR -> Scanner.CAMERA_ERROR
            com.qrshield.model.ErrorCode.IMAGE_DECODE_ERROR -> Scanner.IMAGE_DECODE_ERROR
            com.qrshield.model.ErrorCode.IMAGE_TOO_LARGE -> Scanner.IMAGE_TOO_LARGE
            com.qrshield.model.ErrorCode.INVALID_IMAGE -> Scanner.INVALID_IMAGE
            com.qrshield.model.ErrorCode.INVALID_QR_FORMAT -> Scanner.INVALID_QR_FORMAT
            com.qrshield.model.ErrorCode.DECODE_ERROR -> Scanner.DECODE_ERROR
            com.qrshield.model.ErrorCode.CONTENT_TOO_LARGE -> Scanner.CONTENT_TOO_LARGE
            com.qrshield.model.ErrorCode.ML_KIT_ERROR -> Scanner.ML_KIT_ERROR
            com.qrshield.model.ErrorCode.VISION_ERROR -> Scanner.VISION_ERROR
            com.qrshield.model.ErrorCode.LIBRARY_NOT_LOADED -> Scanner.LIBRARY_NOT_LOADED
            com.qrshield.model.ErrorCode.UNKNOWN_ERROR -> Generic.UNKNOWN_ERROR
        }
    }
}
