...
Mehr Guard's `PhishingEngine` is a pure Kotlin Multiplatform implementation designed to produce **identical verdicts** on all platforms. This document provides reproducible test methodology for verifying that claim.
...
```
═══════════════════════════════════════════════════════════════
           Mehr Guard CROSS-PLATFORM PARITY PROOF
═══════════════════════════════════════════════════════════════
...
### Engine Location
```
common/src/commonMain/kotlin/com/mehrguard/core/PhishingEngine.kt
```

### Parity Test Location
```
common/src/commonTest/kotlin/com/mehrguard/benchmark/PlatformParityProofTest.kt
```
...
*Report generated by Mehr Guard Cross-Platform Parity System*
